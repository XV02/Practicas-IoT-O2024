...
// Codigo clase IoT - Luis Gabriel Hernández Hernández
...
#define DEVICE_NAME "ESPLuisGHH"  // Cambiar este nombre para cada estudiante
...
class MyServerCallbacks: public BLEServerCallbacks {
    void onConnect(BLEServer* pServe  r) {
