// Práctica hecha por Luis Gabriel Hernández Hernández - clase IoT
...
#define greenLed 2           // Pin para el LED verde (acceso concedido)
#define redLed 5             // Pin para el LED rojo (acceso denegado)
...
byte Usuario1[4] = {0x9D, 0xBD, 0xE8, 0x4D}; // UID tarjeta CON acceso (reemplaza por tu UID)
byte Usuario2[4] = {0xC1, 0xA0, 0x2B, 0x19}; // UID de otra tarjeta que quieras que tenga acceso
