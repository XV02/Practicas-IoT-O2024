...
// wifi credentials
const char *ssid = "Robamesta";
const char *password = "1234567890";
WiFiClient  client;

// OpenWeather
String apiTemperature;
String serverPath = "https://api.openweathermap.org/data/2.5/weather?lat=20.607660883081998&lon=-103.41656769139999&appid=212926a458131dde827bac675e6f7a82&units=metric";


// ThingSpeak
uint32_t channelNumber = 2720802;
const char *writeAPIKey = "TY636DNN779YTCCP";
...
void sendDataToThingSpeak(){
    ...
    int code = ThingSpeak.writeFields(2720802, "TY636DNN779YTCCP");
    if(code == 200)
